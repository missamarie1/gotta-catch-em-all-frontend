...
export const medium = [
  2, 5, 8, 11, 14, 17, 20, 22, 24, 26, 28, 30, 32, 36, 38, 40, 42, 44, 47, 49,
  51, 53, 55, 57, 59, 61, 64, 67, 70, 73, 75, 78, 80, 82, 85, 87, 89, 91, 93,
  97, 99, 101, 103, 105, 110, 112, 117, 119, 121, 130, 133, 139, 141, 148,
];

export const hard = [
  3, 6, 9, 12, 15, 18, 31, 34, 45, 62, 65, 68, 71, 76, 94, 106, 107, 131, 134,
  135, 136, 142, 143, 144, 145, 146, 149, 150, 151,
];
